...
export const translations = {
  uk: {
    ...
    Wishlist: {
      ...
      remove: 'Видалити',
      addingToCart: 'Додається в кошик...',
    ...
    BurgerMenu: {
      ...
      footer: {
        copyright: 'MadEdge. Всі права захищено.',
      },
    },
    ...
    Shop: {
      ...
      sharpeners: 'Професійні точилаs',
      stones: 'Точильні Камені',
    ...
    Profile: {
      ...
      phoneLabel: 'Телефон:',
      // Нові рядки
      tabOrders: 'Історія замовлень',
      tabAddresses: 'Адреси доставки',
      tabSecurity: 'Безпека',
      saveButton: 'Зберегти зміни',
      savingButton: 'Збереження...',
      saveSuccess: 'Профіль оновлено!',
      passwordSaveSuccess: 'Пароль успішно змінено!',
      passwordErrorLength: 'Пароль має бути не менше 6 символів.',
      ...
      updatingPasswordButton: 'Оновлення...',
      addAddressButton: 'Додати адресу',
      noAddresses: 'Ви ще не додали жодної адреси.',
      noOrders: 'Ви ще не зробили жодного замовлення.',
      AddressForm: {
        title: 'Додати нову адресу',
        countryLabel: 'Країна *',
        selectCountryPlaceholder: 'Оберіть країну',
        stateLabel: 'Область / Штат',
        selectRegionPlaceholder: 'Оберіть регіон',
        noRegionsPlaceholder: 'Немає регіонів',
        cityLabel: 'Місто *',
        postalCodeLabel: 'Поштовий індекс *',
        addressLine1Label: 'Вулиця, будинок *',
        addressLine1Placeholder: 'Вул. Шевченка 1, кв. 10',
        addressLine2Label: 'Додаткова інформація (опціонально)',
        addressLine2Placeholder: "Під'їзд, код домофону тощо",
        phoneLabel: 'Телефон *',
        phonePlaceholder: '+380...',
        phoneHelperText:
          'Ми використали ваш номер з профілю. Ви можете змінити його для цієї адреси.',
        setDefaultLabel: 'Зробити основною адресою',
        saveButton: 'Зберегти',
        cancelButton: 'Скасувати',
      },
      AddressManager: {
        title: 'Адреси доставки',
        addButton: 'Додати адресу',
        emptyStateTitle: 'Ви ще не додали жодної адреси.',
        emptyStateDesc: 'Додайте адресу для швидкого оформлення замовлень.',
        defaultBadge: 'Основна',
        setAsDefaultTooltip: 'Зробити основною',
        deleteTooltip: 'Видалити',
        confirmDelete: 'Ви впевнені, що хочете видалити цю адресу?',
        toasts: {
          addSuccess: 'Адресу успішно додано!',
          addError: 'Помилка при збереженні адреси',
          deleteSuccess: 'Адресу видалено',
          deleteError: 'Не вдалося видалити адресу',
          setDefaultSuccess: 'Основну адресу змінено',
        },
      },
      Security: {
        title: 'Зміна паролю',
        forgotPassword: "Я не пам'ятаю поточний пароль",
        confirmGlobalSignOut:
          'Ви впевнені? Вам доведеться увійти знову на цьому пристрої.',
        ...
        placeholders: {
          currentPassword: 'Введіть старий пароль',
          newPassword: 'Введіть новий пароль',
          confirmPassword: 'Повторіть новий пароль',
        },
        buttons: {
          update: 'Оновити пароль',
          updating: 'Перевірка та оновлення...',
        },
        errors: {
          passwordLength: 'Новий пароль має бути не менше 6 символів.',
          passwordMismatch: 'Паролі не збігаються.',
          wrongCurrentPassword: 'Невірний поточний пароль',
          updateError: 'Сталася помилка при зміні паролю',
        },
        success: {
          passwordChanged: 'Пароль успішно змінено!',
          resetEmailSent: 'Лист для відновлення надіслано на {email}',
          globalSignOut: 'Вихід виконано з усіх пристроїв',
        },
        dangerZone: {
          title: 'Зона небезпеки',
          signOutTitle: 'Вийти з усіх пристроїв',
          signOutDesc:
            "Це завершить вашу сесію на всіх комп'ютерах та телефонах, де ви увійшли.",
          signOutButton: 'Вийти всюди',
        },
      },
      Edit: {
        title: 'Мій профіль',
        ...
        statusUnconfirmed: 'НЕ ПІДТВЕРДЖЕНО',
        unconfirmedWarning:
          'Неможливо оформити замовлення без підтвердженої пошти.',
        verifyEmailButton: 'Підтвердити пошту',
        sending: 'Надсилання...',
        verificationEmailSent: 'Лист підтвердження надіслано на {email}',

        notSpecified: 'Не вказано',
        cantChange: '(не можна змінити)',
        notConfirmedBadge: 'Не підтверджено',
      ...
      OrderHistory: {
        ...
        emptyDesc: 'Ви ще не зробили жодного замовлення.',
        orderNumber: '№',
        itemsHeader: 'Товари',
        quantityUnit: 'шт.',
    ...
    Order: {
      ...
      selectAddress: 'Оберіть адресу',
      shippingMethod: 'Спосіб доставки',
      standard: 'Стандартна',
      standardDesc: 'Звичайна доставка',
      express: 'Експрес',
      expressDesc: 'Швидка доставка',
      na: 'Н/Д',
      processing: 'Обробка...',
      errorAuth: 'Ви не авторизовані. Будь ласка, увійдіть.',
      errorEmail:
        'Для оформлення замовлення необхідно підтвердити електронну пошту.',
      errorSelectAddress: 'Оберіть адресу доставки',
      errorAddressNotFound: 'Помилка: обрану адресу не знайдено',
    ...
    OrderResult: {
      ...
      goToOrders: 'Перейти до замовлень',
    ...
    UpdatePassword: {
      title: 'Новий пароль',
      description: 'Будь ласка, введіть ваш новий пароль нижче.',
      placeholder: 'Введіть новий пароль',
      button: 'Змінити пароль',
      buttonLoading: 'Збереження...',
    ...
    AuthForm: {
      ...
      signupSuccessTitle: 'Акаунт створено!',
      signupSuccessDesc:
        'На вашу пошту надіслано лист. Будь ласка, підтвердіть її, щоб мати можливість оформлювати замовлення.',
      signupSuccessAction: 'Зрозуміло',
    },
  },
  en: {
    Main: {
    ...
    BurgerMenu: {
      ...
      footer: {
        copyright: 'MadEdge. All rights reserved.',
      },
    },
    Shop: {
      // Секція завантаження та помилок
      ...
      sharpeners: 'Knife Sharpeners',
      stones: 'Grinding Stones',
    ...
    Profile: {
      ...
      AddressForm: {
        ...
        addressLine1Placeholder: '123 Main St, Apt 4',
        addressLine2Label: 'Additional Info (optional)',
        addressLine2Placeholder: 'Building entrance, intercom code, etc.',
        phoneLabel: 'Phone *',
        phonePlaceholder: '+1...',
        phoneHelperText:
          'We pre-filled this from your profile. You can change it for this address.',
      ...
      AddressManager: {
        ...
        emptyStateTitle: 'You haven’t added any addresses yet.',
        emptyStateDesc: 'Add an address for faster checkout.',
        defaultBadge: 'Default',
        setAsDefaultTooltip: 'Set as default',
        ...
        toasts: {
          ...
          setDefaultSuccess: 'Default address changed',
        },
      },
      Security: {
        title: 'Change Password',
        forgotPassword: "I don't remember my current password",
        confirmGlobalSignOut:
          'Are you sure? You will need to log in again on this device.',
        ...
        buttons: {
          ...
          updating: 'Verifying and updating...',
        },
        errors: {
          passwordLength: 'New password must be at least 6 characters.',
          passwordMismatch: 'Passwords do not match.',
          wrongCurrentPassword: 'Incorrect current password',
          updateError: 'Error occurred while changing password',
        },
        success: {
          passwordChanged: 'Password changed successfully!',
          resetEmailSent: 'Recovery email sent to {email}',
          globalSignOut: 'Logged out from all devices',
        },
        dangerZone: {
          title: 'Danger Zone',
          signOutTitle: 'Sign out from all devices',
          signOutDesc:
            'This will end your session on all computers and phones where you are logged in.',
      ...
      Edit: {
        ...
        statusConfirmed: 'VERIFIED',
        statusUnconfirmed: 'UNVERIFIED',
        unconfirmedWarning: 'You cannot place orders without a verified email.',
        ...
        notConfirmedBadge: 'Not verified',

        fullNamePlaceholder: 'Your full name',
        phonePlaceholder: '+1...',
        phoneHelper:
          'This number will be automatically suggested when adding new addresses.',
    ...
    Order: {
      ...
      standard: 'Standard',
      standardDesc: 'Standard delivery',
      express: 'Express',
      expressDesc: 'Fast delivery',
      na: 'N/A',
      processing: 'Processing...',
      errorAuth: 'You are not authorized. Please sign in.',
      errorEmail: 'You need to verify your email to place an order.',
      errorSelectAddress: 'Select delivery address',
      errorAddressNotFound: 'Error: selected address not found',
      errorDeliveryUnavailable:
    ...
    OrderResult: {
      ...
      successMessage:
        'Your payment was successfully processed. We have already started assembling your order.',
      errorMessage:
        'Unfortunately, an error occurred while processing the payment. Please try again or contact support.',
    ...
    AuthForm: {
      ...
      signupSuccessDesc:
        'A verification email has been sent. Please confirm it to enable ordering.',
      signupSuccessAction: 'Got it',
    },
  },
} as const;
