...
export const translations = {
  ua: {
    ...
    Order: {
      ...
      errorDeliveryUnavailable: 'Доставка цього типу недоступна в ваш регіон',
  ...
  en: {
    ...
    Order: {
      ...
      errorAuth: 'You are not logged in. Please log in.',
      errorEmail: 'You must confirm your email to place an order.',
      errorSelectAddress: 'Please select a delivery address',
      errorAddressNotFound: 'Error: selected address not found',
      errorDeliveryUnavailable:
        'This delivery type is unavailable in your region',
