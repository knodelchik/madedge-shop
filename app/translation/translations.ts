...
export const translations = {
  ua: {
    ...
    footerWhetstones: 'Водяні камені',
    footerAccessories: 'Аксесуари',
    footerAboutUs: 'Про нас',
    footerOurBackground: 'Наша історія',
    footerOurValues: 'Наші цінності',
    footerManufacturing: 'Виробництво',
    footerMadEdgeServices: 'Послуги MadEdge',
    footerUpcomingEvents: 'Майбутні події',
  ...
  en: {
    ...
    footerMadEdgeServices: 'MadEdge Services',
    footerUpcomingEvents: 'Upcoming Events',
