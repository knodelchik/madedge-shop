...
export default function AboutPage() {
  return (
    <>
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">About MadEdge</h1>
      ...
      <section id="our-background" className="mb-16 scroll-mt-32">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-gray-700 mb-4">
            Founded in 2010, MadEdge emerged from a simple observation: artists,
            craftsmen, and professionals deserved better tools to maintain their
            instruments. What started as a small workshop in Portland has grown
            into a leading manufacturer of premium sharpening solutions used by
          ...
          <p className="text-gray-700 mb-4">
            Our founder, Marcus Davidson, a former industrial designer, noticed
            the frustration artists faced with conventional sharpeners. He spent
            three years researching metallurgy, blade geometry, and ergonomics
            to create the first MadEdge prototype. That prototype evolved into
            our flagship ProEdge series, now trusted by over 100,000
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            <ul className="space-y-3">
              <li className="flex items-start">
                <span className="font-semibold text-blue-600 mr-3">2010:</span>
                <span className="text-gray-700">
                  Company founded in Portland, Oregon
                </span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-blue-600 mr-3">2013:</span>
                <span className="text-gray-700">
                  First ProEdge model launched
                </span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-blue-600 mr-3">2017:</span>
                <span className="text-gray-700">
                  Expanded to international markets
                </span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-blue-600 mr-3">2021:</span>
                <span className="text-gray-700">
                  Introduced sustainable manufacturing practices
                </span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-blue-600 mr-3">2024:</span>
                <span className="text-gray-700">
      ...
      <section id="our-values" className="mb-16 scroll-mt-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-orange-50 p-6 rounded-lg">
            ...
            <p className="text-gray-700">
              Your satisfaction is our priority. We offer lifetime support and a
      ...
      <section id="manufacturing" className="mb-16 scroll-mt-32">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Manufacturing</h2>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="border-l-4 border-blue-600 pl-4 py-2">
            ...
            <p className="text-gray-700">
              Every sharpener undergoes 50+ quality checks including blade angle
          ...
          <div className="border-l-4 border-blue-600 pl-4 py-2">
            ...
            <p className="text-gray-700">
              Products are packaged in eco-friendly materials with comprehensive
              user guides.
            </p>
          </div>
        </div>
