...
export default function OrderHistory({ userId }: { userId: string }) {
  // Використовуємо namespace 'Profile.OrderHistory'
  ...
  // Використовуємо переклади для статусів
              ...
              <div className="flex items-center justify-between md:justify-end gap-4">
                ...
                <div className="flex -space-x-3">
                  {order.order_items.slice(0, 3).map((item, idx) => (
                    <div
                      key={idx}
                      className="relative w-10 h-10 rounded-full border-2 border-white dark:border-neutral-800 bg-white dark:bg-neutral-900 overflow-hidden"
                    >
                      {item.image_url ? (
                        <Image
                          src={item.image_url}
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500 dark:text-neutral-400 mt-1 capitalize">
                            {order.shipping_type} {t('deliverySuffix')} •{' '}
