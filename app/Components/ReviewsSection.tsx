      ...
      >
        ...
        >
          <motion.button
            ...
            className="px-6 py-3 rounded-full bg-black dark:bg-white text-white dark:text-black font-medium hover:bg-neutral-800 dark:hover:bg-neutral-300 transition-colors duration-300 cursor-pointer"
